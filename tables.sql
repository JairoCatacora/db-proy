...
CREATE TABLE publisher(
    ...
    n_seguidores SMALLINT NOT NULL,
...
CREATE TABLE publicacion(
    ...
    prom_puntuacion SMALLINT NOT NULL ,
...
--Tabla Juego
CREATE TABLE juego(
    juego_id VARCHAR(15) PRIMARY KEY,
    FOREIGN KEY (juego_id) REFERENCES producto(producto_id)
);

--Tabla DLC
CREATE TABLE dlc(
    dlc_id VARCHAR(15) PRIMARY KEY,
    juego_id VARCHAR(15) REFERENCES juego(juego_id),
...
ALTER TABLE biblioteca ADD CONSTRAINT valid_logros CHECK ( h_jugadas >= 0 );
...
CREATE TABLE publica(
    publisher_id VARCHAR(16) PRIMARY KEY,
    tienda_region VARCHAR(20) PRIMARY KEY,
    publicacion_id VARCHAR(16) PRIMARY KEY,
    --producto_id VARCHAR(16) PRIMARY KEY,
...
--Tabla Tiene
CREATE TABLE tiene(
    nom_categoria VARCHAR(15) PRIMARY KEY,
    producto_id VARCHAR(16) PRIMARY KEY,
